...
> 📖 **스터디원용 가이드**: [guide/STUDY_GUIDE.md](guide/STUDY_GUIDE.md) — 프로젝트 의의, 사용 방법, 한 줄 요약

### 프로젝트 의의

- **수동 입력 한계 극복**: 이미지 한 장으로 OCR + AI가 정답·해설·키워드 자동 추출 → 문제 등록 시간 대폭 단축
- **체계적 관리**: 태그(초빈출, 별표100개 등)로 분류해 놓친 문제 파악
- **실전 연습**: 랜덤/과목별/전체 모의고사로 시험 대비
